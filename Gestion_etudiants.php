...
?>
    ...
    <div class="c col-6">
            <br>
            <pre>Créer un étudiant       <a type="btn" href="Create.php">Créer</a></pre>
            <pre>Supprimer un étudiant   <a type="btn" href="Delete.php">Supprimer</a></pre>
            <pre>Modifier un étudiant    <a type="btn" href="Update.php">Modifier</a></pre>
            <br>
        </div>
    </div>
    </div>
