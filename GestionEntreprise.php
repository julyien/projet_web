...
<div class="bg"></div>
    ...
    if (array_key_exists("error",$_GET)){ 
        switch ($_GET['error']){
            case 'update':
                echo '<div> <span class="text-danger">Impossible de modifier cette entreprise</span></div>';
                break;
            case 'delete':
                echo '<div> <span class="text-danger">Impossible de supprimer cette entreprise</span></div>';
                break;
        }
    }
    ?>
