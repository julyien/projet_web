...
if ($id_profil !== "") {
    ...
    prenom_profil,promotion_profil,identifiant_profil,password_profil,id_centre,id_role FROM profil WHERE id_profil='$id_profil'");
...
$result = array("$nom_profil", "$prenom_profil","$promotion_profil","$identifiant_profil","$password_profil","$id_centre","$id_role");
