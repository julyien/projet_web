...
echo '<pre><strong>Titre du poste :</strong></pre> <option value="' . $row['nom_offre'] . '">' . $row['nom_offre'] . '</option>';
echo '<pre><strong>ID Offre :</strong></pre> <option value="' . $row['id_offre'] . '">' . $row['id_offre'] . '</option>';
echo ' <pre><strong>Description du poste : </strong></pre> <option value="' . $row['description_offre'] . '">' . $row['description_offre'] . '</option>';
echo '<div class="b">';
echo '<br>';
echo '<h3>Statistiques</h3>';
echo '<pre><strong>Localités : </strong></pre> <option value="' . $row['ville_localisation'] . '">' . $row['ville_localisation'] . '</option>';
echo '<pre><strong>Durée du stage : </strong></pre> <option value="' . $row['duree_offre'] . '">' . $row['duree_offre'] . '</option>';
echo '<pre><strong>Base de rémunération : </strong></pre> <option value="' . $row['base_remuneration_offre'] . '">' . $row['base_remuneration_offre'] . '</option>';
echo '<pre><strong>Date offre : </strong></pre> <option value="' . $row['date_offre'] . '">' . $row['date_offre'] . '</option>';
echo '<pre><strong>Nombre de place offertes aux étudiants : </strong></pre> <option value="' . $row['nombre_place_offre'] . '">' . $row['nombre_place_offre'] . '</option>';
echo '<br>';
