...
<head>
    ...
    <link href="Statistiques.css" rel="Stylesheet" type="text/css"/>
</head>
<body>
    <div class="topnav">
    ...
    <br>
    <div class="center" > <h2> Statistiques : </h2> </div>
    <br>
    <br>
    <br>
    <br>
...
<div class="c col-md-5 offset-md-1">
    <div class="brd">
        <div class="a"><button type="button">Favoris</button></div>
            ...
            <div class="b">
                <br>
                Evaluer l'entreprise : <button type="button">Like</button>   <button type="button">Dislike</button> </div>
                <div class="a">
                <br>
                <button type="button">Détails</button>       <button type="button">Postuler</button> </div>
            </div>
        </div>
    </div>
</div>
