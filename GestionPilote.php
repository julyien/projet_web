...
?>
    ...
    <div class="c col-6">
            <br>
            <pre>Créer un pilote       <a  href="CreatePilote.php">Créer</a></pre>
            <pre>Supprimer un pilote   <a  href="DeletePilote.php">Supprimer</a></pre>
            <pre>Modifier un pilote    <a  href="UpdatePilote.php">Modifier</a></pre>
            <br>
        </div>
    </div>
</body>
